	...
	<div class="col-md-12 col-sm-12 col-xs-12">
	  <div class="x_panel">
		<div class="x_title">
		  ...
		  <h2  class="col-md-6">Danh sách sinh viên</h2>
			...
			<tbody>
			  ...
			  <?php foreach ($list as $row) { $i++;?>
				  <tr>
					...
					<td>
					 <a class="btn btn-info btn-xs" href="<?php echo base_url('admin/students/edit/'.$row->id)?>"><i class="fa fa-pencil"></i> Sửa</a>
    ...
    function confirmEdit(id) {
     ...
     function confirmDel(id) {
            if (confirm('Bạn có chắc chắc muốn xoa không!')) {
                window.location.href = '<?php echo base_url('admin/students/del/')?>' + id;
            }
        }
</script>
