				...
				<form action="" method="post" data-parsley-validate enctype="multipart/form-data" class="form-horizontal">
					<div class="card">
						...
						<div class="card-body card-block">
							<div class="row form-group">
								...
								<div class="col-12 col-md-9">
									<input type="text" id="text-input" name="thietbi" value="<?php echo $res->thietbi ?>" placeholder="Nhập ten thiet bi" class="form-control">
								</div>
							</div>
							<div class="row form-group">
								<div class="col col-md-3">
								...
								<div class="col-12 col-md-9">
									<input type="number" id="email-input" name="soluong" value="<?php echo $res->soluong ?>" placeholder="Nhập so luong" class="form-control">
								</div>
							</div>
							<div class="row form-group">
								<div class="col col-md-3">
								...
								<div class="col-12 col-md-9">
									<input type="text" id="password-input" name="trangthai" value="<?php echo $res->trangthai ?>" placeholder="Nhập trang thai" class="form-control">
								</div>
							</div>
							<div class="row form-group">
								<div class="col col-md-3">
						...
						<div class="card-footer">
							...
							<a href="<?php echo admin_url('product/edit'); ?>"> <input type="submit" class="btn btn-danger btn-sm" value="Reset"></a>
						</div>
					</div>
				</form>
				</div>
