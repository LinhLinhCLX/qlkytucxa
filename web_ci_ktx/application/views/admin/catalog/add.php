				...
				<form action="" method="post" data-parsley-validate enctype="multipart/form-data" class="form-horizontal">
					<div class="card">
						...
						<div class="card-body card-block">
							<div class="row form-group">
								...
								<div class="col-12 col-md-9">
									<input type="text" id="text-input" name="toanha" placeholder="Nhập toa nha" class="form-control">
								</div>
							</div>
							<div class="row form-group">
								<div class="col col-md-3">
								...
								<div class="col-12 col-md-9">
									<input type="number" id="email-input" name="tang" placeholder="Nhập so tang" class="form-control">
								</div>
							</div>
							<div class="row form-group">
								<div class="col col-md-3">
								...
								<div class="col-12 col-md-9">
									<input type="text" id="password-input" name="phong" placeholder="Nhập so phong" class="form-control">
								</div>
							</div>
						...
						<div class="card-footer">
							...
							<a href="<?php echo admin_url('catalog/add'); ?>"> <input type="submit" class="btn btn-danger btn-sm" value="Reset"></a>
						</div>
					</div>
				</form>
				</div>
