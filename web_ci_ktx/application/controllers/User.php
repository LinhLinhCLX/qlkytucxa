...
Class User extends MY_Controller
{
    ...
    function check_email()
    {
        ...
        if($this->sinhvien_model->check_exists($where))
        {
    ...
    private function _get_user_info()
    {
        ...
        $user = $this->sinhvien_model->get_info_rule($where);
        return $user;
    }
    ...
    function edit()
    {
        ...
        $user = $this->sinhvien_model->get_info($user_id);
        if(!$user)
        {
            redirect();
        }
        ...
        if($this->input->post())
        {
            ...
            if($this->form_validation->run())
            {
                ...
                if($this->sinhvien_model->update($user_id, $data))
                {
                    //tạo ra nội dung thông báo
